...
# split the "common" class 50/50 source and target
idx_s = idx.copy()
idx_t = idx.copy()

# n_common = len(idx[common_class])
# n_split = int(n_common*0.5)
# idx_s[common_class] = idx_s[common_class][:n_split]
# idx_t[common_class] = idx_t[common_class][n_split:]

# sample for source
idx_s = idx_s[source_labels[0]] + idx_s[source_labels[1]]
y_s = y[idx_s]
X_s = X[idx_s]
# set class 0 to -1
...
idx_t = idx_t[target_labels[0]] + idx_t[target_labels[1]]
y_t = y[idx_t]
X_t = X[idx_t]
# set class 2 to -1
